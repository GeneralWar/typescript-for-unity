declare namespace UnityEngine
{
	export class Joint extends UnityEngine.Component
	{
		...
		public get autoConfigureConnectedAnchor(): number;
		public set autoConfigureConnectedAnchor(): number;
		public get breakForce(): number;
		public set breakForce(): number;
		public get breakTorque(): number;
		public set breakTorque(): number;
		public get enableCollision(): number;
		public set enableCollision(): number;
		public get enablePreprocessing(): number;
		public set enablePreprocessing(): number;
