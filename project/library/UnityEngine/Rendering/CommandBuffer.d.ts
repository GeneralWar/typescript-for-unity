declare namespace UnityEngine
{
	declare namespace Rendering
	{
		export class CommandBuffer
		{
			...
			public ClearRenderTarget(clearDepth: number, clearColor: number, backgroundColor: UnityEngine.Color): void;
			public ClearRenderTarget(clearDepth: number, clearColor: number, backgroundColor: UnityEngine.Color, depth: number): void;
			...
			public GetTemporaryRT(nameID: number, width: number, height: number, depthBuffer: number, filter: UnityEngine.FilterMode, format: UnityEngine.RenderTextureFormat, readWrite: UnityEngine.RenderTextureReadWrite, antiAliasing: number, enableRandomWrite: number): void;
			public GetTemporaryRT(nameID: number, width: number, height: number, depthBuffer: number, filter: UnityEngine.FilterMode, format: UnityEngine.RenderTextureFormat, readWrite: UnityEngine.RenderTextureReadWrite, antiAliasing: number, enableRandomWrite: number, memorylessMode: UnityEngine.RenderTextureMemoryless): void;
			public GetTemporaryRT(nameID: number, width: number, height: number, depthBuffer: number, filter: UnityEngine.FilterMode, format: UnityEngine.RenderTextureFormat, readWrite: UnityEngine.RenderTextureReadWrite, antiAliasing: number, enableRandomWrite: number, memorylessMode: UnityEngine.RenderTextureMemoryless, useDynamicScale: number): void;
			...
			public GetTemporaryRTArray(nameID: number, width: number, height: number, slices: number, depthBuffer: number, filter: UnityEngine.FilterMode, format: UnityEngine.RenderTextureFormat, readWrite: UnityEngine.RenderTextureReadWrite, antiAliasing: number, enableRandomWrite: number): void;
			public GetTemporaryRTArray(nameID: number, width: number, height: number, slices: number, depthBuffer: number, filter: UnityEngine.FilterMode, format: UnityEngine.RenderTextureFormat, readWrite: UnityEngine.RenderTextureReadWrite, antiAliasing: number, enableRandomWrite: number, useDynamicScale: number): void;
			...
			public SetInvertCulling(invertCulling: number): void;
			...
			public SetRandomWriteTarget(index: number, buffer: UnityEngine.ComputeBuffer, preserveCounterValue: number): void;
