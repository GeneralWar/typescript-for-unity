declare namespace UnityEngine
{
	...
	export class Rect extends System.ValueType
	{
		...
		public Contains(point: UnityEngine.Vector2): number;
		public Contains(point: UnityEngine.Vector3): number;
		public Contains(point: UnityEngine.Vector3, allowInverse: number): number;
		public Equals(other: any): number;
		public Equals(other: UnityEngine.Rect): number;
		public GetHashCode(): number;
		public Overlaps(other: UnityEngine.Rect): number;
		public Overlaps(other: UnityEngine.Rect, allowInverse: number): number;
