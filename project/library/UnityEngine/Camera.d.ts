declare namespace UnityEngine
{
	...
	export class Camera extends UnityEngine.Behaviour
	{
		...
		public RenderToCubemap(cubemap: UnityEngine.Cubemap): number;
		public RenderToCubemap(cubemap: UnityEngine.RenderTexture): number;
		public RenderToCubemap(cubemap: UnityEngine.Cubemap, faceMask: number): number;
		public RenderToCubemap(cubemap: UnityEngine.RenderTexture, faceMask: number): number;
		public RenderToCubemap(cubemap: UnityEngine.RenderTexture, faceMask: number, stereoEye: UnityEngine.Camera.MonoOrStereoscopicEye): number;
		...
		public get useJitteredProjectionMatrixForTransparentRendering(): number;
		public set useJitteredProjectionMatrixForTransparentRendering(): number;
		...
		public get stereoEnabled(): number;
		...
		public get areVRStereoViewMatricesWithinSingleCullTolerance(): number;
		public get usePhysicalProperties(): number;
		public set usePhysicalProperties(): number;
		public get clearStencilAfterLightingPass(): number;
		public set clearStencilAfterLightingPass(): number;
		...
		public get allowHDR(): number;
		public set allowHDR(): number;
		public get allowMSAA(): number;
		public set allowMSAA(): number;
		public get allowDynamicResolution(): number;
		public set allowDynamicResolution(): number;
		public get forceIntoRenderTexture(): number;
		public set forceIntoRenderTexture(): number;
		...
		public get layerCullSpherical(): number;
		public set layerCullSpherical(): number;
		...
		public get useOcclusionCulling(): number;
		public set useOcclusionCulling(): number;
