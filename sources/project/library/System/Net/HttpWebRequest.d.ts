declare namespace System
{
	declare namespace Net
	{
		export class HttpWebRequest extends System.Net.WebRequest
		{
			...
			public get Pipelined(): number;
			public set Pipelined(): number;
			...
			public get SupportsCookieContainer(): number;
			...
			public set IfModifiedSince(): number;
			public get Address(): System.Uri;
			public get AllowAutoRedirect(): number;
			public set AllowAutoRedirect(): number;
			public get AllowWriteStreamBuffering(): number;
			public set AllowWriteStreamBuffering(): number;
			public get AllowReadStreamBuffering(): number;
			public set AllowReadStreamBuffering(): number;
			public get AutomaticDecompression(): number;
			public set AutomaticDecompression(): number;
			...
			public get UnsafeAuthenticatedConnectionSharing(): number;
			public set UnsafeAuthenticatedConnectionSharing(): number;
			...
			public set Date(): number;
			public get Expect(): string;
			public set Expect(): string;
			public get HaveResponse(): number;
