	...
	declare namespace Net
	{
		declare namespace Sockets
		{
			export class SendPacketsElement
			{
				...
				public constructor(filepath: string, offset: number, count: number, endOfPacket: number);
				public constructor(buffer: number[], offset: number, count: number, endOfPacket: number);
				public get FilePath(): string;
				public get Buffer(): number[];
				public get Count(): number;
				public get Offset(): number;
				public get EndOfPacket(): number;
			}
		}
	}
}
