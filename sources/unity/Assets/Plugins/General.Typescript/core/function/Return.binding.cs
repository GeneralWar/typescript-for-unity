...
namespace General.Typescript
{
    partial class Entry
    {
        static public class Return
        {
            ...
            [DllImport(LIBRARY_NAME)]
            extern static private int General_Typescript_Return_CreateBoolean(IntPtr context, bool value);
            static internal int Create(bool value)
            {
                return General_Typescript_Return_CreateBoolean(sInstance.Context, value);
            }
            ...
            static internal int Create(object value)
            {
                ...
                else if (null != value)
                {
                    ...
                    IntPtr handle = GCHandle.ToIntPtr(GCHandle.Alloc(value, GCHandleType.Pinned));
#else
                    IntPtr handle = GCHandle.ToIntPtr(GCHandle.Alloc(value, GCHandleType.Normal));
#endif
