...
namespace General.Typescript
{
	public abstract partial class Class : Base
    {
		...
		{
			return new Class<T>(mContext, Entry.General_Typescript_Class_DeclareClass(this, typeof(T).Name));
		}

		public Enum<T> DeclareEnum<T>()
		{
			return new Enum<T>(mContext, Entry.General_Typescript_Class_DeclareEnum(this, typeof(T).Name));
		}
