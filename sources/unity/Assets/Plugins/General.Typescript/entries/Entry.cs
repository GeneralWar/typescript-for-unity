...
namespace General.Typescript
{
	public abstract partial class Entry
	{
		...
		private bool toObject(Type type, IntPtr handle, out object instance)
		{
			...
			//			UnityEngine.Debug.LogWarning("Try to convert unknown type from js to csharp!");
			//			result = false;
			//			break;
			//		default:
			//			//UnityEngine.Debug.LogWarning("Try to convert null|undefined from js to csharp!");
			//			result = true;
			//			break;
			//	}
			//}
			...
			//		//if (null == instance)
			//		//{
			//		//	UnityEngine.Debug.LogErrorFormat("Trying to convert a nonexistent instance to {0}!", type.FullName);
			//		//}
			//		//else
			//		//{
			...
			//		//	{
			//		//		instance = null;
			//		//		UnityEngine.Debug.LogErrorFormat("Trying to convert instance from {0} to {1}!", instanceType.FullName, type.FullName);
			//		//	}
			//		//}
			//		//result = true;
			//	}
		...
		public object fromJSObject(IntPtr handle, Type type)
		{
			...
			//				else
			//				{
			//					UnityEngine.Debug.LogErrorFormat("Trying to convert JSValueType.{0}[] to {1}[]!", jsSubType.ToString(), subType.FullName);
			//				}
			//			}
			...
			//			{
			//				UnityEngine.Debug.LogWarning("General.Typescript does not support multi-dimensional array, please wait for upgrade...");
			//			}
			//		}
			//	}
			//	else
			//	{
			//		UnityEngine.Debug.LogErrorFormat("Trying to convert JSValueType.{0} to an array!", jsType.ToString());
			//	}
   ...
   //                 return Entry.ToString(handle);
			...
			//	default:
			//		UnityEngine.Debug.LogWarningFormat("Unexpected jstype {0} without handler!", jsType.ToString());
			//		break;
			//}
			//UnityEngine.Debug.LogWarningFormat("Unexpected type {0} without handler, please contact author...", type.FullName);
			return null;
		}
