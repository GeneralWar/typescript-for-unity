...
namespace General.Typescript
{
	public class SystemNetSocketsTcpClient
	{
		...
		static private void Close(System.Net.Sockets.TcpClient instance, Parameters parameters)
		{
			if (0 == parameters.Count)
			{
				instance.Close();
		...
		static private void Connect(System.Net.Sockets.TcpClient instance, Parameters parameters)
		{
			if (parameters.CheckTypes<System.Net.IPEndPoint>())
			{
		...
		static private System.Threading.Tasks.Task ConnectAsync(System.Net.Sockets.TcpClient instance, Parameters parameters)
		{
			if (parameters.CheckTypes<System.Net.IPAddress, System.Int32>())
			{
		...
		static private void Dispose(System.Net.Sockets.TcpClient instance, Parameters parameters)
		{
			if (0 == parameters.Count)
			{
				instance.Dispose();
		...
		static private void EndConnect(System.Net.Sockets.TcpClient instance, Parameters parameters)
		{
		...
		static private System.Net.Sockets.NetworkStream GetStream(System.Net.Sockets.TcpClient instance, Parameters parameters)
		{
			if (0 == parameters.Count)
			{
		...
		static private System.Net.Sockets.Socket get_Client(System.Net.Sockets.TcpClient instance)
		{
			return instance.Client;
		}

		static private void set_Client(System.Net.Sockets.TcpClient instance, System.Net.Sockets.Socket value)
		{
			instance.Client = value;
		}

		static private System.Int32 get_Available(System.Net.Sockets.TcpClient instance)
		{
			return instance.Available;
		}

		static private System.Boolean get_Connected(System.Net.Sockets.TcpClient instance)
		{
			return instance.Connected;
		}

		static private System.Boolean get_ExclusiveAddressUse(System.Net.Sockets.TcpClient instance)
		{
			return instance.ExclusiveAddressUse;
		}

		static private void set_ExclusiveAddressUse(System.Net.Sockets.TcpClient instance, System.Boolean value)
		{
			instance.ExclusiveAddressUse = value;
		}

		static private System.Int32 get_ReceiveBufferSize(System.Net.Sockets.TcpClient instance)
		{
			return instance.ReceiveBufferSize;
		}

		static private void set_ReceiveBufferSize(System.Net.Sockets.TcpClient instance, System.Int32 value)
		{
			instance.ReceiveBufferSize = value;
		}

		static private System.Int32 get_SendBufferSize(System.Net.Sockets.TcpClient instance)
		{
			return instance.SendBufferSize;
		}

		static private void set_SendBufferSize(System.Net.Sockets.TcpClient instance, System.Int32 value)
		{
			instance.SendBufferSize = value;
		}

		static private System.Int32 get_ReceiveTimeout(System.Net.Sockets.TcpClient instance)
		{
			return instance.ReceiveTimeout;
		}

		static private void set_ReceiveTimeout(System.Net.Sockets.TcpClient instance, System.Int32 value)
		{
			instance.ReceiveTimeout = value;
		}

		static private System.Int32 get_SendTimeout(System.Net.Sockets.TcpClient instance)
		{
			return instance.SendTimeout;
		}

		static private void set_SendTimeout(System.Net.Sockets.TcpClient instance, System.Int32 value)
		{
			instance.SendTimeout = value;
		}

		static private System.Net.Sockets.LingerOption get_LingerState(System.Net.Sockets.TcpClient instance)
		{
			return instance.LingerState;
		}

		static private void set_LingerState(System.Net.Sockets.TcpClient instance, System.Net.Sockets.LingerOption value)
		{
			instance.LingerState = value;
		}

		static private System.Boolean get_NoDelay(System.Net.Sockets.TcpClient instance)
		{
			return instance.NoDelay;
		}

		static private void set_NoDelay(System.Net.Sockets.TcpClient instance, System.Boolean value)
		{
