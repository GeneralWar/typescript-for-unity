...
{
	public class UnityEngineTexture3D
	{
		static public void Bind(Namespace space)
		{
			Class<UnityEngine.Texture3D> self = space.DeclareClass<UnityEngine.Texture3D, UnityEngine.Texture>();
		...
		static private UnityEngine.Texture3D Constructor(Parameters parameters)
		{
			...
			{
				return new UnityEngine.Texture3D(parameters[0].ToObject<System.Int32>(), parameters[1].ToObject<System.Int32>(), parameters[2].ToObject<System.Int32>(), parameters[3].ToObject<UnityEngine.Experimental.Rendering.GraphicsFormat>(), parameters[4].ToObject<UnityEngine.Experimental.Rendering.TextureCreationFlags>());
			}
			if (parameters.CheckTypes<System.Int32, System.Int32, System.Int32, UnityEngine.TextureFormat, System.Boolean>())
			{
				return new UnityEngine.Texture3D(parameters[0].ToObject<System.Int32>(), parameters[1].ToObject<System.Int32>(), parameters[2].ToObject<System.Int32>(), parameters[3].ToObject<UnityEngine.TextureFormat>(), parameters[4].ToObject<System.Boolean>());
			}
			if (0 == parameters.Count)
			{
				UnityEngine.Debug.LogError("UnityEngine.Texture3D.constructor has no implemention without arguments!");
			}
			else
			{
				...
				UnityEngine.Debug.LogErrorFormat("UnityEngine.Texture3D.constructor has no implemention with arguments ({0})!", string.Join(", ", types));
			}
		...
		static private UnityEngine.Color[] GetPixels(UnityEngine.Texture3D instance, Parameters parameters)
		{
			...
			UnityEngine.Debug.LogErrorFormat("UnityEngine.Texture3D.GetPixels has no implemention with arguments ({0})!", string.Join(", ", types));
			return null;
		}
		...
		static private UnityEngine.Color32[] GetPixels32(UnityEngine.Texture3D instance, Parameters parameters)
		{
			...
			UnityEngine.Debug.LogErrorFormat("UnityEngine.Texture3D.GetPixels32 has no implemention with arguments ({0})!", string.Join(", ", types));
			return null;
		}
		...
		static private void SetPixels(UnityEngine.Texture3D instance, Parameters parameters)
		{
			...
			if (0 == parameters.Count)
			{
				UnityEngine.Debug.LogError("UnityEngine.Texture3D.SetPixels has no implemention without arguments!");
			}
			else
			{
				string[] types = new string[parameters.Count];
				...
				UnityEngine.Debug.LogErrorFormat("UnityEngine.Texture3D.SetPixels has no implemention with arguments ({0})!", string.Join(", ", types));
			}
		}
		...
		static private void SetPixels32(UnityEngine.Texture3D instance, Parameters parameters)
		{
			...
			if (0 == parameters.Count)
			{
				UnityEngine.Debug.LogError("UnityEngine.Texture3D.SetPixels32 has no implemention without arguments!");
			}
			else
			{
				string[] types = new string[parameters.Count];
				...
				UnityEngine.Debug.LogErrorFormat("UnityEngine.Texture3D.SetPixels32 has no implemention with arguments ({0})!", string.Join(", ", types));
			}
		}
