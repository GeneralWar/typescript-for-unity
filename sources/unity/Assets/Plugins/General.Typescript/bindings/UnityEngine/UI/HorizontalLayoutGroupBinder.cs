...
namespace General.Typescript
{
	public class UnityEngineUIHorizontalLayoutGroup
	{
		...
		static private void CalculateLayoutInputHorizontal(UnityEngine.UI.HorizontalLayoutGroup instance, Parameters parameters)
		{
		...
		static private void CalculateLayoutInputVertical(UnityEngine.UI.HorizontalLayoutGroup instance, Parameters parameters)
		{
			if (0 == parameters.Count)
			{
		...
		static private void SetLayoutHorizontal(UnityEngine.UI.HorizontalLayoutGroup instance, Parameters parameters)
		{
			if (0 == parameters.Count)
			{
		...
		static private void SetLayoutVertical(UnityEngine.UI.HorizontalLayoutGroup instance, Parameters parameters)
		{
			if (0 == parameters.Count)
			{
