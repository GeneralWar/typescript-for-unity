...
double ValueToDouble(Local<Value>& value)
{
	...
	return value->IsBigInt() ? value.As<BigInt>()->Int64Value() : 0;
}
...
std::string GetObjectType(const Local<Object>& value)
{
	...
	Local<Value> isType = value->Get(String::NewFromUtf8(isolate, UNITY_INSTANCE_IS_TYPE));
